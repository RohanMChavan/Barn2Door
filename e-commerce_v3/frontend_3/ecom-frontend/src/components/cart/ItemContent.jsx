...
const handleQtyDecrease = (cartItems) => {
  ...
  return (
    <div className="grid md:grid-cols-5 grid-cols-4 md:text-md text-sm  gap-4 items-center border-[1px] border-slate-200 rounded-md lg:px-4 p-2">
      ...
      <div className="justify-self-center lg:text-[17px] text-sm text-slate-600 front-semibold">
