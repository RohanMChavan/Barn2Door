...
const Contact = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1520052203542-d3095f1b6cf0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8aW5kaWFuJTIwZmFybWVyfGVufDB8fDB8fHww')",
      }}
    >
